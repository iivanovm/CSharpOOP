...
namespace BookingApp.Core
{
    public class Controller : IController
    {
        ...
        private string[] validRoomType=Validation.GetChildClassNames(typeof(Room)).ToArray();
        ...
        {
            string fullName = $"BookingApp.Models.Rooms.Models.{roomTypeName}";
            if (hotels.Select(hotelName) == null)
            {
            ...
            if(!validRoomType.Contains(roomTypeName)) { 
                throw new ArgumentException(ExceptionMessages.RoomTypeIncorrect);
            }
            hotel.Rooms.AddNew((IRoom)Validation.CreateInstanceFromString(fullName));
